  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden bg-background text-foreground">
      <header
        ...
        className="pointer-events-none flex min-h-10 shrink-0 items-center justify-end gap-2 border-b bg-background px-3 pt-[var(--titlebar-height)] pr-[max(0.75rem,var(--window-controls-inset,0px))] pb-1"
      >
        <Button
          type="button"
          variant="ghost"
          data-testid="chrome-settings"
          className="pointer-events-auto h-8 shrink-0 gap-2 rounded-lg px-2 text-muted-foreground hover:text-foreground"
          onClick={() =>
      ...
      <div
        ...
        style={{
          ...
          ["--window-controls-inset" as string]: "0px",
        }}
      >
        {!initialized ? (
